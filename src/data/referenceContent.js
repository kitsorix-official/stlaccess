...
export const scaleInfo = {
    ...
    "1:48": {
        ...
        printNote: "1:48 aircraft wingspans can be large; plan bed orientation carefully to avoid supports on visible surfaces.",
        commonIssue: "1:48 figures are often molded in soft vinyl rather than hard plastic. If 3D printing replacements, increase wall thickness for durability.",
    },
    "1:56": {
        shortName: "1:56",
