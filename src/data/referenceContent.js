...
export const scaleInfo = {
    "28mm": {
        shortName: "28mm",
        games: ["classic fantasy RPG", "fantasy RPG", "WWII platoon wargame (28mm) infantry", "ranked fantasy mass-battle game", "anime-influenced sci-fi skirmish game", "sci-fi skirmish game", "gang warfare skirmish game"],
        type: "gaming",
    ...
    "35mm": {
        shortName: "35mm",
        games: ["35mm sci-fi mass-battle game", "superhero skirmish game (35mm)", "monster-hunting RPG", "fantasy mass-battle game"],
        type: "gaming",
    ...
    "75mm": {
        shortName: "75mm",
        games: ["Display busts", "Miniature painting competitions", "display-scale figure lines"],
        type: "display",
    ...
    "1:27": {
        shortName: "1:27",
        games: ["space opera fighter game (ships)"],
        type: "ratio",
        note: "Ship scale for space opera fighter game. No infantry — it's all vehicles and fighters, so the math stays clean.",
        printNote: "The ships are big enough for my FDM printer to handle detail; I use a 0.2mm nozzle for cockpits and panel lines.",
        commonIssue: "Ships span from tiny fighters to huge capital ships, so print time swings wildly. I plan the bed accordingly.",
    },
    "1:48": {
        shortName: "1:48",
        games: ["US O-gauge trains", "space opera model kits", "Aircraft model kits"],
        type: "ratio",
        note: "Common for vehicles and aircraft, with minis as accessories to the kits. This is my go-to for WWII platoon wargame vehicles.",
    ...
    "1:56": {
        shortName: "1:56",
        games: ["WWII platoon wargame", "WWII platoon wargame", "vehicular combat game", "28mm wargaming vehicle companion"],
        type: "ratio",
        note: "The official 1:56 WWII platoon wargame vehicle scale, and it lines up with 28mm infantry — which is exactly how I use it.",
    ...
    "1:72": {
        shortName: "1:72",
        games: ["model kit manufacturer", "model kit manufacturer", "model kit manufacturer", "historical miniatures makers"],
        type: "ratio",
    ...
    "6mm": {
        shortName: "6mm",
        games: ["mech tactical game", "epic-scale sci-fi wargame (classic)", "miniature vehicle toys"],
        type: "gaming",
    ...
    "8mm": {
        shortName: "8mm",
        games: ["epic-scale sci-fi wargame (8mm)", "epic-scale sci-fi wargame (8mm)", "epic-scale civil-war setting"],
        type: "gaming",
        note: "The publisher's modern epic scale. When I want Titans and massed infantry in one battle, this is the one.",
        printNote: "8mm infantry is small but manageable on FDM. Titans and big vehicles are some of my favorite prints.",
        commonIssue: "These two epic-scale sci-fi wargames (8mm) share the scale but not the base sizes — easy to trip over.",
    },
    "10mm": {
        shortName: "10mm",
        games: ["10mm sci-fi mass-battle game", "epic-scale fantasy wargame", "10mm skirmish ruleset"],
        type: "gaming",
    ...
    "30mm": {
        shortName: "30mm",
        games: ["steampunk fantasy wargame", "fantasy skirmish game", "fantasy skirmish game"],
        type: "gaming",
        note: "The in-between scale, stockier than 28mm with exaggerated weapons and armor. Feels beefy on the table.",
        printNote: "30mm steampunk fantasy wargame minis print well on FDM; the steam-powered war machines are big enough that I just run 0.2mm layers.",
        commonIssue: "30mm gets sold as '28mm heroic' or '32mm heroic' by different makers. I measure, always.",
    },
    "15mm": {
        shortName: "15mm",
        games: ["15mm WWII company wargame", "modern-era company wargame", "epic-scale sci-fi wargame", "DBA", "epic-scale fantasy wargame"],
        type: "gaming",
    ...
    "1:100": {
        shortName: "1:100",
        games: ["15mm WWII company wargame", "modern-era company wargame", "15mm wargaming", "Micro-armor"],
        type: "ratio",
